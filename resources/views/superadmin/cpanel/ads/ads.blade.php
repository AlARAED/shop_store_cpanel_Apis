                        ...
                        <div class="col-lg-12 ks-panels-column-section">
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="{{route('superadmin.addads')}}"  enctype="multipart/form-data"   onsubmit="return Validate(this);">
                                        @csrf
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
                                                                                 -->
                                                                                <form method="POST" action="{{url('superadmin/deleteads/'.$ad->id)}}"  enctype="multipart/form-data"   onsubmit="return Validate(this);">
                                                                                    @csrf
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <form method="POST" action="{{url('superadmin/editads/'.$ad->id)}}"  enctype="multipart/form-data"   onsubmit="return Validate(this);">
                                                                                    @csrf
