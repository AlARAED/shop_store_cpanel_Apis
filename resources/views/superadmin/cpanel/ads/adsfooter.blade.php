                    ...
                    <div class="col-lg-12 ks-panels-column-section">
                        <div class="card">
                            <div class="card-block">
                                <h5 class="card-title"> انشاء  اعلان جديد</h5>
                                <form method="POST" action="{{route('superadmin.addadsfoot')}}"  enctype="multipart/form-data"   onsubmit="return Validate(this);">
                                    @csrf


                                    <div class="form-group row">
                                        <label for="default-input" class="col-sm-2 form-control-label"> اسم الاعلان </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="default-input"  name="name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="default-input-rounded" class="col-sm-2 form-control-label">اختر البائع</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="default-input-rounded" class="col-sm-2 form-control-label">ارفاق صورة الاعلان </label>
                                        <div class="col-sm-10">
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <table id="example"  style="width:100%" class="table table-striped table-bordered display nowrap" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$ad->name}}</td>
                                                            <td>{{$ad->StoreName()->name}}</td>
                                                            <td><img src="{{asset('uploads/'.$ad->image)}}" alt="" width="100px" height="100px"></td>
                                                            <td><div class="ks-controls">
                                                                    ...
                                                                    <button type="button" class="btn btn-danger"  data-toggle="modal"
                                                                            data-target="#centralModalSmedel{{ $ad->id }}">ازالة</button>
                                                                    <button type="button" class="btn btn-primary"    data-toggle="modal"
                                                                            data-target="#myModal{{ $ad->id }}" >تعديل</button>
                                                                </div></td>

                                                        </tr>

                                                        <div class="modal fade" id="centralModalSmedel{{ $ad->id }}" tabindex="-1"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
                                                                         -->
                                                                        <form method="POST" action="{{url('superadmin/deleteadsfooter/'.$ad->id)}}"  enctype="multipart/form-data"   onsubmit="return Validate(this);">
                                                                            @csrf
                                                            ...
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form method="POST" action="{{url('superadmin/editadsfooter/'.$ad->id)}}"  enctype="multipart/form-data"   onsubmit="return Validate(this);">
                                                                            @csrf
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="default-input" class="col-sm-2 form-control-label"> اسم الاعلان </label>
                                                                                <div class="col-sm-10">
                                                                                    <input type="text" class="form-control" id="default-input"  name="name"  value="{{$ad->name}}" required>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <div class="col-sm-10">
                                                                                    <button class="btn btn-primary ks-btn-file">
                                                                                        <span class="la la-cloud-upload ks-icon"></span>
                                                                                        <span class="ks-text">اختر الصورة </span>
                                                                                        <input type="file" name="image"  value="{{ $ad->image }}"   >
                                                                                    </button>
                                                                                </div>
                                                                            </div>
