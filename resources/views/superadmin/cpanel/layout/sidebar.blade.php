        ...
        <section>
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="nav-item dropdown">
                    <a class="nav-link "  href="{{ url('superadmin/index') }}" role="button" aria-haspopup="true" aria-expanded="false">
                        <span class="ks-icon la la-dashboard"></span>
                        <span>الرئيسية</span>
                    </a>
                    {{--<div class="dropdown-menu">--}}
                        {{--<a class="dropdown-item" href="index.html">انشاء متاجر</a>--}}
                        {{--<a class="dropdown-item" href="dashboards-mail.html">  انشاء اعلانات للمتاجر</a>--}}
                        {{--<a class="dropdown-item" href="dashboards-projects.html"></a>--}}
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link "  href="{{ url('superadmin/addcategory') }}" role="button" aria-haspopup="true" aria-expanded="false">
                        <span class="ks-icon la la-flask"></span>
                        <span> انشاء تصنيف رئيسى</span>
                    </a>

                    </li>
                <li class="nav-item dropdown">

                <a class="nav-link "  href="{{ url('superadmin/addstore') }}" role="button" aria-haspopup="true" aria-expanded="false">
                        <span class="ks-icon la la-money"></span>
                        <span> انشاء متجر</span>
                    </a>
                </li>
                ...
                <a class="nav-link "  href="{{ url('superadmin/addads') }}" role="button" aria-haspopup="true" aria-expanded="false">
                        <span class="ks-icon la la-ticket"></span>
                        <span> اعلان متجر الرئيسية</span>
                    </a>
                ...
                <a class="nav-link "  href="{{ url('superadmin/addstorefooter') }}" role="button" aria-haspopup="true" aria-expanded="false">
                        <span class="ks-icon la la-ticket"></span>
                        <span> اعلان متجر الفوتر</span>
                    </a>
