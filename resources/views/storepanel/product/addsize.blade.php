                        ...
                        <div class="col-lg-12 ks-panels-column-section">
                            <div class="card">
                                <div class="card-block">
                                    <h5 class="card-title">انشاء   احجام المنتجات</h5>
                                    <form method="POST" action="{{route('storepanel.addsize')}}"  enctype="multipart/form-data"   onsubmit="return Validate(this);">
                                                    ...
                                                    <div class="container-fluid">
                                                        ...
                                                        <table id="example"  style="width:100%" class="table table-striped table-bordered display nowrap" cellspacing="0"
                                                            ...
                                                            @foreach($Size  as $Siz)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><div class="ks-controls">
                                                                            ...
                                                                            <button type="button" class="btn btn-danger"  data-toggle="modal"
                                                                                    data-target="#centralModalSmedel{{ $Siz->id }}">ازالة</button>
                                                                            <button type="button" class="btn btn-primary"    data-toggle="modal"
                                                                                    data-target="#myModal{{ $Siz->id }}" >تعديل</button>
                                                                        </div></td>

                                                                </tr>

                                                                <div class="modal fade" id="centralModalSmedel{{ $Siz->id }}" tabindex="-1"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
                                                                                 -->
                                                                                <form method="POST" action="{{url('storepanel/deletesize/'.$Siz->id)}}"  enctype="multipart/form-data"   onsubmit="return Validate(this);">
                                                                                    @csrf
                                                                ...
                                                                <div class="modal fade" id="myModal{{ $Siz->id }}" role="dialog">
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <form method="POST" action="{{url('storepanel/editsize/'.$Siz->id)}}"  enctype="multipart/form-data"   onsubmit="return Validate(this);">
                                                                                    @csrf
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <input type="text" class="form-control" id="default-input" name="name"   value="{{ $Siz->name }}" required>
                                                                                    </div>
